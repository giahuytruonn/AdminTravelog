...
function createEmailTemplate(title, message, buttonText = null, buttonLink = null, isError = false) {
    ...
    .onUpdate(async (change, context) => {
        ...
        try {
            ...
            if (newData.status === 'payment_pending') {
                ...
                const domain = "http://localhost:5173"; // Thay bằng link thật của bạn
                ...
                htmlContent = createEmailTemplate(subject, msg, "THANH TOÁN NGAY", paymentLinkData.checkoutUrl);
            }
            // TRƯỜNG HỢP 2: KÍCH HOẠT THÀNH CÔNG
                ...
                htmlContent = createEmailTemplate(subject, msg, "TRUY CẬP DASHBOARD", "http://localhost:5173");
            }
